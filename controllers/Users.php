...
?>
    ...
    xhttp.open("GET", "http://localhost:8000/ci/users/get_user_lastloggedin", true);
...
<?php
	...
	public function check_temp($taskid) {

		echo "this is temp test".$taskid;
	}
}
